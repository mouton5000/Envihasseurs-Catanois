...
class TestEchange(TestJoueur):
    def setUp(self):
        ...
        self.act1 = Action(1, NodeCst.NULL, 'acheter_carte_developpement', '1')
        self.act2 = Action(2, NodeCst.NULL, 'acheter_carte_developpement', '1')
        self.act3 = Action(3, NodeCst.NULL, 'acheter_carte_developpement', '1')
        self.act4 = Action(4, NodeCst.NULL, 'acheter_carte_developpement', '1')
        self.act5 = Action(5, NodeCst.NULL, 'acheter_carte_developpement', '1')
        self.act6 = Action(6, NodeCst.NULL, 'acheter_carte_developpement', '1')
        self.act7 = Action(7, NodeCst.NULL, 'acheter_carte_developpement', '1')
        self.act8 = Action(8, NodeCst.NULL, 'acheter_carte_developpement', '1')
        self.act9 = Action(9, NodeCst.NULL, 'acheter_carte_developpement', '1')
        self.act10 = Action(10, NodeCst.NULL, 'acheter_carte_developpement', '1')
        

        self.act11 = Action(11, NodeCst.NULL, 'acheter_carte_developpement', '1')
        self.act12 = Action(12, NodeCst.NULL, 'acheter_carte_developpement', '1')
        self.act13 = Action(13, NodeCst.NULL, 'acheter_carte_developpement', '1')
        self.act14 = Action(14, NodeCst.NULL, 'acheter_carte_developpement', '1')
        self.act15 = Action(15, NodeCst.NULL, 'acheter_carte_developpement', '1')
        self.act16 = Action(16, NodeCst.NULL, 'acheter_carte_developpement', '1')
        self.act17 = Action(17, NodeCst.NULL, 'acheter_carte_developpement', '1')
        self.act18 = Action(18, NodeCst.NULL, 'acheter_carte_developpement', '1')
        self.act19 = Action(19, NodeCst.NULL, 'acheter_carte_developpement', '1')
        self.act20 = Action(20, NodeCst.NULL, 'acheter_carte_developpement', '1')
