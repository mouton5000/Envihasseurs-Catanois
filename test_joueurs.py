...
class TestJoueur(unittest.TestCase):
    ...
    def setUp(self):
        ...
        Voleur(self.p.hexa(22),Voleur.VoleurType.BRIGAND,self.p.ter(1)).save()
        Voleur(self.p.hexa(1),Voleur.VoleurType.PIRATE,self.p.ter(1)).save()
        
        Voleur(self.p.hexa(25),Voleur.VoleurType.BRIGAND,self.p.ter(2)).save()
        Voleur(self.p.hexa(4),Voleur.VoleurType.PIRATE,self.p.ter(2)).save()
