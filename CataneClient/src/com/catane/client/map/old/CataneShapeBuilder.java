...
class CataneShapeBuilder extends ShapeBuilder{
	...
	/**
	 * Dessine un triangle de coordonnées M0,M1,M2.
	 * @param x
	 * @param y
	 * @return
	 */
	public CataneShapeBuilder drawArrow(double[] coords) {
			this.cMoveTo(coords[0],coords[1])
			.drawLineTo(coords[2],coords[3])
			.drawLineTo(coords[4],coords[5]);
