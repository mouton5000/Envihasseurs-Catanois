package com.catane.client.map.old;
//
...
public class MapOld extends Surface implements Connectable {
...
//
	private MapOld(int width, int height){
		super(width,height);
//		origin = new Vector2(0,0);
//
////		mmh = new MapMouseHandler(this);
////		this.addClickHandler(mmh);
...
//	
//	void setMapClickHandler(MapClickHangler mch){
//		mmh.setMapClickHandler(mch);
//	}
//	
...
//
//	private static final int BIG_MAP_WIDTH = 1600;
//	private static final int BIG_MAP_HEIGHT = 800;
//	
//	public static Widget getBigMap() {
//		if(bigMap == null)
...
//
//
//	private void drawHexagones(ArrayList<int[]> hexagones){		
//		for(int[] infos : hexagones){
...
//		drawPions(x0,x1,y0,y1);
//	}
//
//	public void drawPions(double x0, double x1, double y0, double y1){
//		drawPions(getHexagones(x0, x1, y0, y1));
//	}
//
//	private void drawPions(ArrayList<int[]> hexagones){
//		for(int[] infos : hexagones){
...
//	}
//
//	private void draw(double x0, double x1, double y0, double y1){
//		ArrayList<int[]> hexagones = getHexagones(x0,x1,y0,y1);
//		drawHexagones(hexagones);
//		drawPions(hexagones);
//	}
//
//	/**
...
//
//	/**
//	 * Renvoie les hexagones actuellement visibles sur la carte entre les coordonnées x0, x1, y0, y1,
//	 * associée à deux chiffres :
...
//	 * @return
//	 */
//	private ArrayList<int[]> getHexagones(double x0, double x1, double y0, double y1){
//		int[] limits = getLimits(x0,x1,y0,y1);
...
//	 * @return
//	 */
//	private int[] getLimits(double x0, double x1, double y0, double y1){
//
...
//
//	private Map drawLink(int i, int j, LinkType link, int deltaLine, int deltaColumn, int player){
////		this.setFillStyle(PlayerColors.getPlayerColor(player));
...
//	}
//
//	private Map translateX(double x){
//		double x0 = origin.getX(),
...
//	}
//
//	private Map translateY(double y){
//
...
//	}
//
//	public double[] getCoords(ArrowType arrow){
//
//		double x0 = 0, y0=0 , 
//				x1 = 0,y1 = 0,
//				x2 = 0,y2 = 0;
//		switch(arrow){
//		case DOWN:
//			x0 = origin.getX()+ getWidth()/2;
//			y0 = origin.getY() + getHeight()-10;
//			x1 = x0-30;
//			y1 = y0-30;
//			x2 = x0+30;
//			y2 = y0-30;
...
//	}
//
//	public Shape getShape(ArrowType arrow){
//		double[] coords = getCoords(arrow);
//		return new CataneShapeBuilder().drawArrow(coords).build();
//	}
//
//	private ArrowType currentArrow = ArrowType.NONE;
//	
//	private Map arrow(ArrowType arrow){
//		removeArrows();
//		Shape s = getShape(arrow);
//		this.setFillStyle(KnownColor.WHITE);
//		this.fillShape(s);
//		this.setStrokeStyle(KnownColor.BLACK);
//		this.strokeShape(s);
...
//	
//	Map arrowLeft(){
//		return arrow(ArrowType.LEFT);
//	}
//
//	Map arrowRight(){
//		return arrow(ArrowType.RIGHT);
//	}
//
//	Map arrowUp(){
//		return arrow(ArrowType.UP);
//	}
//
//	Map arrowDown(){
//		return arrow(ArrowType.DOWN);
//	}
//
//	Map arrowUpLeft(){
//		return arrow(ArrowType.UPLEFT);
//	}
//
//	Map arrowUpRight(){
//		return arrow(ArrowType.UPRIGHT);
//	}
//
//	Map arrowDownLeft(){
//		return arrow(ArrowType.DOWNLEFT);
//	}
//
//	Map arrowDownRight(){
//		return arrow(ArrowType.DOWNRIGHT);
//	}
//
//	Map removeArrows(){
//		if(currentArrow != ArrowType.NONE){
//			double[] coords = getCoords(currentArrow);
//			double x0 = Math.min(coords[0], Math.min(coords[2],coords[4]));
//			double x1 = Math.max(coords[0], Math.max(coords[2],coords[4]));
//			double y0 = Math.min(coords[1], Math.min(coords[3],coords[5]));
//			double y1 = Math.max(coords[1], Math.max(coords[3],coords[5]));
//			draw(x0,x1,y0,y1);
//			currentArrow = ArrowType.NONE;
//		}
//		return this;
//	}
//
